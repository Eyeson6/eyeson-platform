...
public class TreeConfig extends SerializeCloneable {
     ...
     * setFieldParentID(fieldParentID); return this; }
     *
     * public TreeConfig putFieldID(String fieldID) { setFieldID(fieldID);
     * return this; } public TreeConfig putFieldText(String fieldText) {
     * setFieldText(fieldText); return this; } public TreeConfig
     * putFieldChecked(String fieldChecked) { setFieldChecked(fieldChecked);
     * return this; } public TreeConfig putFieldAttributes(String[]
     * fieldAttributes) { setFieldAttributes(fieldAttributes); return this; }
     * public TreeConfig putFieldAttributes(String fieldAttributes) {
     * setFieldAttributes(fieldAttributes); return this; } public TreeConfig
     * putState(String state) { setState(state); return this; } public
     * TreeConfig putRootID(String rootID) { setRootID(rootID); return this; }
     * public TreeConfig putRootText(String rootText) { setRootText(rootText);
     * return this; } public TreeConfig putFieldChild(String fieldChild) {
     * setFieldChild(fieldChild); return this; }
     */
}
